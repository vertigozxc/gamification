...
INSERT INTO "new_User" ("createdAt", "displayName", "id", "intPoints", "lastDailyResetAt", "lastStreakIncreaseAt", "level", "photoUrl", "staPoints", "strPoints", "streak", "updatedAt", "username", "xp", "xpNext") SELECT "createdAt", "displayName", "id", "intPoints", "lastDailyResetAt", "lastStreakIncreaseAt", "level", "photoUrl", "staPoints", "strPoints", "streak", "updatedAt", "username", "xp", "xpNext" FROM "User";
DROP TABLE "User";
